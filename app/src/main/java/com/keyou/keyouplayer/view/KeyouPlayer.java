...
import com.keyou.keyouplayer.adapter.DanamakuAdapter;
import com.keyou.keyouplayer.base.BiliDanmukuParser;
...
public class KeyouPlayer extends StandardGSYVideoPlayer {
    private BiliDanmukuParser mParser;//解析器对象
    ...
    public KeyouPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public KeyouPlayer(Context context) {
        super(context);
    }

    public KeyouPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ((KeyouPlayer) to).mDumakuFile = ((KeyouPlayer) from).mDumakuFile;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            KeyouPlayer gsyVideoPlayer = (KeyouPlayer) gsyBaseVideoPlayer;
            //对弹幕设置偏移记录
    ...
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, GSYVideoPlayer gsyVideoPlayer) {
        ...
        if (gsyVideoPlayer != null) {
            KeyouPlayer gsyDanmaVideoPlayer = (KeyouPlayer) gsyVideoPlayer;
    ...
    public void setDanmaKuStream(File is) {
        ...
        if (!getDanmakuView().isPrepared()) {
            onPrepareDanmaku((KeyouPlayer) getCurrentPlayer());
        }
    }
                ...
                public void prepared() {
                    if (getDanmakuView() != null) {
                        ...
                        if (getDanmakuStartSeekPosition() != -1) {
                            resolveDanmakuSeek(KeyouPlayer.this, getDanmakuStartSeekPosition());
    ...
    private InputStream getIsStream(File file) {
        try {
            ...
            instream.close();
            return new ByteArrayInputStream(buffreader.toString().getBytes());
    ...
    /**
     开始播放弹幕
     */
    private void onPrepareDanmaku(KeyouPlayer gsyVideoPlayer) {
    ...
    /**
     弹幕偏移
     */
    private void resolveDanmakuSeek(KeyouPlayer gsyVideoPlayer, long time) {
    ...
    /**
     ...
     @return
     */
    private BiliDanmukuParser createParser(InputStream stream) {
    ...
    /**
     释放弹幕控件
     */
    private void releaseDanmaku(KeyouPlayer keyouPlayer) {
        if (keyouPlayer != null && keyouPlayer.getDanmakuView() != null) {
            Debuger.printfError("release Danmaku!");
            keyouPlayer.getDanmakuView().release();
        }
    }

    public BiliDanmukuParser getParser() {
        if (mParser == null) {
            if (mDumakuFile != null) {
                mParser = createParser(getIsStream(mDumakuFile));
            }
